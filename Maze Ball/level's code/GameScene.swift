...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    var HoldLabelNode: SKLabelNode!
    var HoldLabelNode2: SKLabelNode!
    var angl: Double = 0.0
    var count_tap : Int = 0;
    var touch = 0;
  ...
  //  let starCategory:UInt32 = 0x1 << 1
    ...
    override func didMove(to view: SKView) {
        ...
        backgroundNode = self.childNode(withName: "level1")
       ...
       // playerNode.physicsBody?.contactTestBitMask = starCategory
        ...
        HoldLabelNode = (self.childNode(withName: "HoldLbl") as! SKLabelNode)
        HoldLabelNode.isHidden = false;
        
        HoldLabelNode2 = (self.childNode(withName: "HoldLbl2") as! SKLabelNode)
        HoldLabelNode2.isHidden = false;
    ...
    override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        if touch == 0
        {
            ...
            HoldLabelNode.isHidden = true;
            HoldLabelNode2.isHidden = true;
