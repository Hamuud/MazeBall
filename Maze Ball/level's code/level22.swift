...
class level22: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        backgroundNode = self.childNode(withName: "level22")
    ...
    @objc func delayedActionDown() {
        let moveDown = SKAction.moveTo(y: 160, duration: 1.5)
    ...
    func stopGame() {
        let scene = SKScene(fileNamed: "EndGameLvl22")
