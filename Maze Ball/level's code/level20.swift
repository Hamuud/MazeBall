...
class level20: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        backgroundNode = self.childNode(withName: "level20")
        ...
        spinnerNode = self.childNode(withName: "Spinner3")
        spinnerNode.physicsBody?.categoryBitMask = spinnerCategory
        spinnerNode.physicsBody?.contactTestBitMask = playerCategory
        spinnerNode.physicsBody?.isDynamic = false
        spinnerNode.run(.rotate(toAngle: 100 * 3.14, duration: 360))

        spinnerNode = self.childNode(withName: "Spinner1")
        spinnerNode.physicsBody?.categoryBitMask = spinnerCategory
        spinnerNode.physicsBody?.contactTestBitMask = playerCategory
        spinnerNode.physicsBody?.isDynamic = false
        spinnerNode.run(.rotate(toAngle: 100 * 3.14, duration: 300))
    ...
    func stopGame() {
        let scene = SKScene(fileNamed: "EndGameLvl20")
